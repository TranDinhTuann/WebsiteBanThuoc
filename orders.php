        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-lg-8 col-xl-6 pt-5" style="height: 650px;">
                <div class="card border-top border-bottom border-3"
                    style="border-color: black !important; height: 100%;"
                    onclick="orderDetail(<?php echo $value['id'];?>)">
                    <div class="card-body p-5">
                        <p class="lead fw-bold mb-5" style="color: #f37a27; text-align:center;color: black">Hóa đơn thanh toán</p>

                        <div class="row">
                            <div class="col mb-3">
                            <p class="small text-muted mb-1">Ngày đặt hàng:</p>
                            <?php if (isset($value['order_date'])): ?>
                        ...
                        <div class="row text-lg-left mt-2">
                            <div class="col-md-4 offset-md-8 col-lg-5 offset-lg-9">
                               <p class="small text-muted mb-1">Tổng tiền:</p>
                                <p class="lead fw-bold mb-0" style="color: black;">
                                    <?php echo number_format($value['total'])?>đ
                                </p>
                            </div>
                        </div>

                        <p class="lead fw-bold mb-4 pb-2" style="color: black;">Trạng thái đơn hàng</p>
                        ...
                        <p class="mt-4 pt-2 mb-0">Có thắc mắc gì? <a href="#!" style="color: black;">Liên hệ sđt: 0325932446
                                </a></p>
                    </div>
                </div>
            </div>
