...
<div class="hero_area" >
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="uploads/medicine.png" alt="" style="height: 100%; width: 80%;margin-top: 40px" >
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box" style="margin-top: 40px">
                    <h1>
                      Hãy đến với quầy thuốc Dũng Nhàn <br>
                      <span>
                        Ngay hôm nay
                      </span>
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box" style="margin-top: 40px">
                    ...
                    <p>
                      Tôi tin rằng món quà lớn nhất mà bạn có thể trao cho gia đình mình và thế giới là sức khỏe tốt của chính mình.
                    </p>
                    <div>
                      <a href="contact.html">
                        Mua ngay
  ...
  <section class="feature_section  layout_padding">
    <div class="container" style="text-align: center">
      <div class="feature_container" style="display: flex; text-align: center">
        <div class="box" style="width:33.33%">
          <div class="img-box" style="width:100px; height: 100px; margin-left: 100px" >
        ...
        <div class="box" style="width:33.33%">
          <div class="img-box" style="width:100px; height: 80px;margin-left: 130px; margin-bottom: 20px">
            <svg id="Capa_1" enable-background="new 0 0 422.518 422.518" height="100" viewBox="0 0 422.518 422.518" width="100"
        ...
        <div class="box" style="width:33.33%">
          <div class="img-box" style="width:100px; height: 100px;margin-left: 130px">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <section>
        ...
        <h1 class="mt-5" style="text-align:center; color: #000"><span class="label label-default text-danger">Tất cả sản phẩm thuốc</span></h1>
        <div class="row">
            ...
            <div class="col-lg-3 mt-3" style="padding:10px; height:488.7px;">
                <div class="card text-center" style="height: 100%">
                    ...
                    <div class="card-body">
                        ...
                        <a href="product-detail.php?id=<?php echo $value['id']?>" class="btn btn-success">Xem chi
                            tiết</a>
                    </div>
                </div>
            </div>
