...
<div class="container">
    <div class="col-lg-8 border p-3 main-section position-relative bg-white">
        <div class=" " style="text-align: center;font-size:40px; ">
            Thông tin chi tiết sản phẩm
        </div>
        <form action="cart.php" method="GET">
        <div class="row m-0">
            <div class="col-lg-4 left-side-product-box pb-3"  >
                <img style="height: 340px" src="uploads/<?php echo $pro['image'] ?>" class="border p-3">
                ...
                <div class="right-side-pro-detail border p-3 m-0">
                    <div class="row">
                        ...
                        <div class="col-lg-12 pt-2">
                            ...
                            <span>Sản phẩm tốt cho mọi người</span>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12 mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <a href="index.php" class="btn btn-success w-100">Shop</a>
                                    </div>
                                </div>
                            </div>
